...
class BattleDB(db.Model):
    ...
    attacker_id=Column(Integer, ForeignKey("TrainerDB.id", ondelete="CASCADE"), nullable=False)
    defender_id=Column(Integer, ForeignKey("TrainerDB.id",ondelete="CASCADE"),nullable=False)
    ...
    def __init__(self, attacker_id,defender_id,attacker_pokemon,defender_pokemon,result,date):
        super().__init__()
